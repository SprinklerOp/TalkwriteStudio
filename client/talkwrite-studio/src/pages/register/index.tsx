...
const Register = () => {
  ...
  return (
    <div
      ...
      style={{ width: widthStr, height: heightStr, marginTop:"20px" }}
    >
        ...
        <div className="flex flex-col space-y-4">
          <div className="w-full text-center flex flex-col justify-center items-center">
           <Logo/>
            ...
            <p className="font-medium">for a TalkWrite account</p>
          </div>
          <TextField
            value={email}
      ...
      <div className="flex justify-center space-x-4 text-sm p-1">
